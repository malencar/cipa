...
if not (dmbanco.FDTransaction6.cONNECTION.InTransaction) then
            dmbanco.FDTransaction6.StartTransaction;
 ...
 {with dmbanco.qryUpdCadastro do begin
  ...
  with dmbanco.FDQuery6 do begin
      close;
      sql.Clear;
...
if not (dmbanco.FDTransaction5.connection.InTransaction) then
            dmbanco.FDTransaction5.StartTransaction;
